...
export default function Expertise() {
  ...
  const areas = [
    ...
    { icon: TrendingUp, key: "automation" },
    { icon: Code, key: "development" },
    { icon: Wrench, key: "infrastructure" },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {areas.map((area) => {
            ...
            return (
              <article
                key={area.key}
                className="group p-8 bg-white/5 backdrop-blur-sm border border-zinc-800 hover:border-zinc-700 rounded-2xl transition-colors duration-300"
              >
                <div className="mb-6 inline-block p-3 bg-zinc-900/50 border border-zinc-800 rounded-lg group-hover:border-zinc-700 transition-colors duration-300">
