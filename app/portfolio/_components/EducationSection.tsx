...
const education = [
  {
    title: "Analista Programador Universitario / Licenciatura en Sistemas",
    institution: "Universidad Nacional del Nordeste (UNNE)",
    period: "En curso - finalización estimada 2026",
    summary:
      "Me formé en diseño de sistemas, modelado de datos, arquitectura de software y metodologías de desarrollo.",
  },
  {
    title: "Talentos Digitales - Full Stack",
    institution:
      "Gobierno de la Provincia de Corrientes - TelCo - UNNE - PoloIT",
    period: "2022",
    summary:
      "Hice entrenamiento intensivo en desarrollo web moderno, trabajo colaborativo y ciclos de entrega ágiles.",
  },
];
...
const continuousLearning = [
  ...
  "Aplicación de inteligencia artificial en procesos manuales.",
];
    ...
    <section id="education" className="relative px-4 py-20">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-12 max-w-3xl space-y-4">
          <p className="text-sm tracking-wide text-zinc-500">Formación</p>
          <h2 className="text-3xl font-semibold tracking-tight text-zinc-100 md:text-4xl">
            Sostengo base académica y aprendizaje continuo
          </h2>
          <p className="text-zinc-400">
            Combino formación formal con aprendizaje práctico para tomar mejores
            decisiones técnicas en proyectos reales.
          </p>
        </div>
